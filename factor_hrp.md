Aplicação de Hierarchical Risk Parity (HRP) nos Fatores de Risco da
Bolsa Brasileira
================
Arthur Wachslicht
...
![](factor_hrp_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
![](factor_hrp_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
```
    ...
    ## 1  0.06040336 0.01443986 0.05589262 0.1769021 0.01065936 0.07875661
...
```
    ...
    ##   Rm_minus_Rf       SMB       HML      WML       IML Portfolio
    ## 1   0.2374784 0.1437963 0.1321334 0.157687 0.1445289 0.0708032
